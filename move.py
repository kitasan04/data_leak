...
def SelectMode(seed=42):
    ...
    print("(1) Move N pieces of each class to train")
    print("(2) Restore the data set to its original state from train")
    print("(3) Move N pieces of each class to leak")
    print("(4) Restore the data set to its original state from leak")
    print("(5) Quite")
    mode = input("mode=")
    if mode == '0':
        seed = int(input('seed='))
